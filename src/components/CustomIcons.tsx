...
// Example: SitemarkIcon
export const SitemarkIcon = React.forwardRef<SVGSVGElement, SvgIconProps>(
  function SitemarkIcon(props, ref) {
    return (
      <SvgIcon
        ref={ref}
        {...props} // allow overriding color, fontSize, sx, etc.
        viewBox="0 0 86 19" // match original svg
      >
        <path
          fill="#B4C0D3"
