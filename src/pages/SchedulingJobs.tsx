                     ...
                     <button
                        onClick={async () => {
                           ...
                           try {
                              ...
                              // Successful response
                              navigate("/scheduling/result", { state: { schedule: data.schedule, scheduledJobs: data.scheduledJobs ?? [], startISO: weekStartISO, endISO: weekEndISO, weekId: selectedWeekStart } });
                           } catch (err) {
                              console.error(err);
